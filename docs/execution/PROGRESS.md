...
| M0-02 | IN_PROGRESS | Codex / Makefile, pyproject.toml, package.json, apps/web, services/*, packages/*, config/*, scripts/* | None | Layout and offline command wrappers created; lock generation and smoke tests pending |
