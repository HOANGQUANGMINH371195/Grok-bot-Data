...
| M1-01 | BLOCKED | Codex / packages/platform/src/vda_platform/identity, packages/platform/src/vda_platform/storage, database/migrations/versions/0003_identity.* | [M1-01-identity-contract.json](receipts/M1-01-identity-contract.json) | Offline membership/resource-grant generation and identity/RLS migration contract pass; OIDC/session runtime, live RLS integration and Leads/Security review pending |
