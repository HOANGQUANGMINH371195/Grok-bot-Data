...
| M1-02 | BLOCKED | Codex / services/api/src/vda_api/application.py, services/api/src/vda_api/main.py, packages/platform/src/vda_platform/conversation/outbox.py | [M1-02-local-bot-slice.json](receipts/M1-02-local-bot-slice.json) | Guarded local human→bot turn and durable bot response/event idempotency pass; DB/WS/reconnect, ACL integration and Core/Web review pending |
