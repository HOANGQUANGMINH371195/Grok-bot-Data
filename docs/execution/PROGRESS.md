...
| M0-04 | IN_PROGRESS | Codex / tests/fixtures, tests/unit/test_fixtures.py | None | Synthetic CSV/provider/policy/expected fixtures and negative shape tests added; Parquet/Decimal corpus and receipt pending |
