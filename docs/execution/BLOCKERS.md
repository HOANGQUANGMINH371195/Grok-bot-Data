...
| BLK-M0-04 | M0-04 | Synthetic CSV/JSON/Decimal/PII/adversarial/provider fixtures and pinned `tests/fixtures/data/flat_small.parquet` (SHA-256 recorded in M0-04 receipt) now exist; independent fixture review and broader corpus sign-off are still missing | Data/QA owner reviews the pinned fixture/golden semantics and signs the receipt | OPEN |
